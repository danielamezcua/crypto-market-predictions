...
label = "label"
suffix_result_filenames = "_svm_ns.txt"
sc = StandardScaler()
...
selected_estimator = SUPPORT_VECTOR_CLASSIFIER
for crypto in cryptos.keys():
	filename_dataset = crypto+"_news.csv"
	filename_result = crypto+suffix_result_filenames
	#open result file
	f = open("../results/svm/"+filename_result,"w")
	f.write("Results for Multilayer Perceptron applied to all reddit data, news data and market data\n")
