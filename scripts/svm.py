...
COINS = {"btc":"BITCOIN", "xrp":"RIPPLE","ltc":"LITECOIN","eth":"ETHEREUM"}
def predict(coin):
	...
	x = dataset_btc.loc[:, ["ratio_pos_ns","ratio_neg_ns","avg_news_compound"]].values
	...
	x = dataset_btc.loc[:, ["ratio_pos_s","ratio_neg_s","avg_news_compound"]].values
	y = dataset_btc.loc[:, "label"].values
